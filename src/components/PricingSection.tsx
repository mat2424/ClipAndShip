  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-lg shadow-lg p-6 border border-border">
        <h2 className="text-xl font-semibold mb-4 text-foreground">Buy Credits</h2>
        <div className="space-y-4">
          {PRICING_TIERS.map(tier => (
            <div key={tier.credits} className="border-border rounded-lg p-4 border">
              {tier.popular && (
                <div className="text-xs font-medium text-primary mb-2">MOST POPULAR</div>
              )}
              <div className="flex justify-between items-center">
                <div>
                  <div className="font-semibold text-foreground">{tier.credits} Credits</div>
                  <div className="text-sm text-foreground">${tier.price}</div>
                ...
                <Button 
                  ...
                  className={tier.popular ? "bg-accent hover:bg-cool-aqua-hover text-accent-foreground" : ""}
                >
      ...
      <div className="bg-card rounded-lg shadow-lg p-6 border border-border">
        <h2 className="text-xl font-semibold mb-4 text-foreground">Upgrade Your Account</h2>
        <div className="space-y-4">
          {SUBSCRIPTION_TIERS.map(tier => {
            const IconComponent = tier.icon;
            return (
              <div key={tier.name} className="border rounded-lg p-4 border-primary/30">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <div className="text-right">
                    <div className="font-semibold text-foreground">${tier.price}/month</div>
                  </div>
                </div>
                <ul className="text-sm text-cool-light space-y-1 mb-3">
