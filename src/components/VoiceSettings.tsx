...
export const VoiceSettings = ({
  ...
  return <>
      <div className="flex items-center space-x-2">
        <Checkbox id="custom-voice" checked={useCustomVoice} onCheckedChange={checked => isProUser && onUseCustomVoiceChange(checked as boolean)} disabled={!isProUser} />
      ...
      {!isProUser && <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg">
      ...
      {isProUser && useCustomVoice && <div>
          <Label htmlFor="voice-file">Upload Voice File</Label>
          <Input id="voice-file" type="file" accept="audio/*" onChange={e => onVoiceFileChange(e.target.files?.[0] || null)} />
